l_speedup=16
if [ -r "${origdir}/2024_1213_S0n004.input.txt" ]; then
	l_tempfn="`gentemp ${origdir}/2024_1213_S0n004.input.txt`"
	l_input+=( -i "${l_tempfn}" -r 1 -i "2024_1213_S0n004-${ovl}%04d.${d_ovlext}" )
	l_tempfiles+=( "$l_tempfn" )
else
	l_input+=( -i "${origdir}/2024_1213_S0n004.mp4" -r 1 -i "2024_1213_S0n004-${ovl}%04d.${d_ovlext}" )
fi
###
